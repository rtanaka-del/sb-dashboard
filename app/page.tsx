...
const MOCK_LIST_DATA: ListRecord[] = [
  ...
  { 
    ...
    status: '', 
    memo: '', 
    extra1: 'Challenge- (確度50%以下リスク有)' 
  },
  { 
    category: 'PipelineNew', 
    date: '', 
    name: 'NIPPON EXPRESSホールディングス株式会社', 
    segment: 'Mid', 
    amount: 7084000, 
    count: 0, 
    owner: '', 
...
const MOCK_OKR_DATA: OkrRecord[] = [
  ...
  { 
    key_result: "オンボーディング標準化", 
    jan: "", feb: "", mar: "", apr: "", may: "", jun: "" 
  },
  { 
    key_result: "3KPI/10%改善", 
    jan: "", feb: "", mar: "", apr: "", may: "", jun: "" 
  },
  { 
    key_result: "競合調査", 
...
// [Mock] Pipeline Agg Data
const MOCK_PIPELINE_AGG: PipelineRecord[] = [
    { 
      type: 'Count_Commit', segment: 'Enterprise', 
      m1:1, m2:0, m3:0, m4:0, m5:0, m6:0 
    },
    { 
      type: 'Count_ChalP', segment: 'Enterprise', 
      m1:4, m2:13, m3:8, m4:24, m5:8, m6:20 
    },
    { 
      type: 'Count_ChalM', segment: 'Enterprise', 
      m1:0, m2:2, m3:1, m4:10, m5:2, m6:5 
    },
    { 
      type: 'Count_Total', segment: 'Enterprise', 
      m1:5, m2:15, m3:9, m4:34, m5:10, m6:25 
    },
    { 
      type: 'Amount', segment: 'Enterprise', 
      m1: 16289417, m2: 11874840, m3: 11849760, m4: 50826379, m5: 10098414, m6: 18688880 
    },
    { 
      type: 'Amount', segment: 'Mid', 
      m1: 15735600, m2: 8430892, m3: 3949990, m4: 16900000, m5: 1621000, m6: 1924000 
    },
    { 
      type: 'Amount', segment: 'Small', 
      m1: 2948800, m2: 1493000, m3: 902700, m4: 1229569, m5: 970200, m6: 803000 
    },
    { 
      type: 'Amount', segment: 'その他', 
      m1: 0, m2: 1570800, m3: 0, m4: 1232000, m5: 0, m6: 0 
    },
];
